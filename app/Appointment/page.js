...
const Appointment = () => {
    ...
    return (
        <div className="max-w-xl mx-auto p-6 md:p-8">
            ...
            <form 
                className="bg-white/80 backdrop-blur-lg shadow-2xl border border-gray-300 rounded-2xl px-8 pt-6 pb-8 space-y-6" 
            ...
            >
                ...
                <div>
                    ...
                    <textarea 
                        ...
                        rows="4" 
                        className="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-3" 
                        placeholder="Write any special requests or symptoms..."
                    ></textarea>
                </div>
                <div className="flex justify-center">
                    <button 
                        type="submit" 
                        className="w-full bg-gradient-to-r from-blue-500 to-blue-700 hover:from-blue-600 hover:to-blue-800 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:scale-105 focus:outline-none focus:ring-4 focus:ring-blue-300 flex items-center justify-center"
                        disabled={loading}
                    >
                        {loading ? (
